...
import com.pepprmint.restomenu.app.dbtables.DBRowItem;
import com.pepprmint.restomenu.app.dbtables.DBRowMenus;
import com.pepprmint.restomenu.app.dbtables.DBTables;
import com.pepprmint.restomenu.app.dbtables.DBTables.Categories;
import com.pepprmint.restomenu.app.dbtables.DBTables.Config;
import com.pepprmint.restomenu.app.dbtables.DBTables.Images;
import com.pepprmint.restomenu.app.dbtables.DBTables.Items;
import com.pepprmint.restomenu.app.dbtables.DBTables.MenuLists;
import com.pepprmint.restomenu.app.dbtables.DBTables.Menus;
...
public class DBContentProvider extends SQLiteOpenHelper{
	...
	public DBContentProvider(Context context){
      ...
      public void onCreate(SQLiteDatabase db) {
      	Log.w(RestoMenuActivity.TAG+"."+TAG,"Creating the database");
      ...
      public void syncMenus(JSONArray jArray){
    	...
    	JSONObject jsonData = null;
  		...
  		try{
			...
			Log.e(RestoMenuActivity.TAG,"JSON Exception :"+e.getMessage());
		}
     ...
     /* public ArrayList<DBRowOrder> getOrderList(JSONArray jArray){
      ...
      public void syncImages(String filename,int id){
    	  ...
    	  try{
    		  ...
    		  Log.e(RestoMenuActivity.TAG, "Error in syncImages: "+e.toString());
    	  }
      }
